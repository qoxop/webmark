(function (global, factory) {
  ...
  var config = {
    ...
    uPageHash: function uPageHash(href) {
  ...
  function getAllMarks() {
    var uPageHash = config.uPageHash,
        getPageInfo = config.getPageInfo;
    var hash = uPageHash(window.location.href);

    if (!AllMarkInfosMap[hash]) {
      AllMarkInfosMap[hash] = JSON.parse(window.localStorage.getItem(hash)) || {
        marks: [],
  ...
  function delMark(id, allRmHandler) {
    var allMarks = getAllMarks();
  ...
  function clearAllMark() {
    ...
    var pageHash = config.uPageHash(window.location.href);
    var markSet = [];
  ...
  setAfterMark(function (mi) {
    var uPageHash = config.uPageHash,
        getPageInfo = config.getPageInfo;
    var hash = uPageHash(mi.href); // @ts-ignore
  ...
  function init() {
    ...
    var pageId = config.uPageHash(window.location.href);
    ...
    if (onUrlChange) {
      var observer = new MutationObserver(function () {
        ...
        cancelKey = setTimeout(function () {
          cancelKey = 0;
          var newPageId = config.uPageHash(window.location.href);
  ...
  exports.clearAllMark = clearAllMark;
  exports.delMark = delMark;
  exports.exportToJson = exportToJson;
  exports.init = init;
  exports.mark = core;
  exports.renderAllMarks = renderAllMarks;
